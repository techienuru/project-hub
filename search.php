...
.pagination a.active {
    background-color: #fcce2d; /* Adjust the color to match your design */
}
      ...
      <div class="header_bg">
         <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <a class="logo navbar-brand" href="index.php"><h1>PROJECT HUB</h1></a>
   ...
   <div class="services_section layout_padding">
      <div class="container">
         ...
         <form action="search.php" method="get" class="nav-link ml-auto w-50 my-4 d-flex">
            <input type="text" name="s" class="form-control text-dark" placeholder="Search projects">
