                                ...
                                <div class="card-body py-0 px-0 px-sm-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-5 col-sm-7 col-xl-8 p-0">
                                            ...
                                            <p class="mb-0 font-weight-normal d-none d-sm-block">Here, you can upload
                                                your project, view previously uploaded project of other students</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-9 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-row justify-content-between border-bottom mb-5">
                                        <h6 class="card-title mb-1 text-muted">Matric Number</h6>
                                        <p class="mb-1"><?php echo $matricno ?></p>
                                    </div>

                                    <div class="d-flex flex-row justify-content-between border-bottom mb-5">
                                        <h6 class="card-title mb-1 text-muted">Level</h6>
                                        <p class="mb-1"><?php echo $level ?></p>
                                    </div>
