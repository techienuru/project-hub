                                ...
                                <div class="card">
                                    ...
                                    <form action="update-profile.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="matricno" value="<?php echo $matricno ?>" class="form-control" placeholder="Enter your password" required>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="level" class="form-control text-white">
                                                ...
                                                <option value="400 Level" <?php if ($level == "400 Level") {
                                                                                echo "selected";
                                                                            } ?>>400 Level</option>
                                                <option value="300 Level" <?php if ($level == "300 Level") {
                                                                                echo "selected";
                                                                            } ?>>300 Level</option>
                                                <option value="200 Level" <?php if ($level == "200 Level") {
                                                                                echo "selected";
                                                                            } ?>>200 Level</option>
                                                <option value="100 Level" <?php if ($level == "100 Level") {
                                                                                echo "selected";
                                                                            } ?>>100 Level</option>
                                                <option value="---" <?php if ($level == "---") {
                                                                        echo "selected";
                                                                    } ?>>--Select Level--</option>
                                            </select>
                                        </div>
